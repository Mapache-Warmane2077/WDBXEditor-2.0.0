...
namespace WDBXEditor
{
    ...
    {
        public ConcurrentDictionary<string, string> FileNames = new();
        public ConcurrentDictionary<string, MemoryStream> Streams = new();
        public bool IsMPQ { get; set; } = true;

        private Locales locale = Locales.EnUS;
        private string filePath;
        private readonly string[] fileExtensions = [".dbc", ".db2"];
        ...
        private async Task LoadMPQDBFiles()
        {
            ...
            {
                using MpqArchive archive = new(filePath, FileAccess.Read);
        ...
        {
            ConcurrentDictionary<string, MemoryStream> _streams = new();
